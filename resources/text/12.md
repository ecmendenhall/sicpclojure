...
#### [Finding roots of equations by the half-interval method](4.html#sec_Temp_103)
...
[fn-56] This can be accomplished using the special form `throw`. Since Clojure is based
